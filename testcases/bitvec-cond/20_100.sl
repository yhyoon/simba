...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) #x0000000000000001 (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) x (ite (= (bvsrem x #x0000000000000008) #x0000000000000002) #x0000000000000001 (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) #x0000000000000001 x) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) x (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) #x0000000000000001 (ite (= (bvurem x #x0000000000000005) #x0000000000000003) #x0000000000000001 x)) #x0000000000000001))) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) x (ite (= (bvsrem x #x0000000000000007) #x0000000000000001) x #x0000000000000001)) x) (ite (= (bvor #x000000000000000e x) x) (ite (= (bvsrem x #x000000000000000a) #x0000000000000000) x #x0000000000000001) (ite (= (bvsrem x #x0000000000000005) #x0000000000000002) #x0000000000000001 x))))))) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvsrem x #x0000000000000009) #x0000000000000002) x (ite (= (bvurem x #x0000000000000007) #x0000000000000002) x #x0000000000000000)) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) #x0000000000000000 (ite (= (bvsrem x #x0000000000000005) #x0000000000000001) (bvxor #x0000000000000002 x) (ite (= (bvurem x #x0000000000000007) #x0000000000000003) #x0000000000000000 (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvxor #x0000000000000002 x) #x0000000000000000) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) #x0000000000000000 (bvxor #x0000000000000002 x)) (bvxor #x0000000000000002 x)))))))))
