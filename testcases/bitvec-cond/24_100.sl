...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) x (ite (= (bvsrem x #x0000000000000009) #x0000000000000002) #x0000000000000001 (ite (= (bvsrem x #x000000000000000c) #x0000000000000001) #x0000000000000001 (ite (= (bvurem x #x000000000000000a) #x0000000000000003) (ite (= (bvor #x0000000000000009 x) x) #x0000000000000001 (ite (= (bvurem x #x0000000000000007) #x0000000000000002) x (ite (= (bvurem x #x0000000000000003) #x0000000000000001) x #x0000000000000001))) (ite (= (bvor #x0000000000000003 x) x) (ite (= (bvsrem x #x0000000000000003) #x0000000000000002) x (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) x (ite (= (bvurem x #x000000000000000b) #x0000000000000001) x (ite (= (bvurem x #x000000000000000e) #x0000000000000001) (ite (= (bvand #x000000000000000d x) #x0000000000000001) #x0000000000000001 x) #x0000000000000001))) #x0000000000000001)) x))))) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvor #x000000000000000a x) x) x (ite (= (bvand #x000000000000000a x) #x0000000000000000) x (bvudiv x #x0000000000000004))) (ite (= (bvsrem x #x000000000000000c) #x0000000000000002) (ite (= (bvand #x000000000000000b x) #x0000000000000002) (bvudiv x #x0000000000000004) (ite (= (bvurem x #x000000000000000b) #x0000000000000002) (bvudiv x #x0000000000000004) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (ite (= (bvsrem x #x0000000000000005) #x0000000000000001) x (bvudiv x #x0000000000000004)) x))) (ite (= (bvurem x #x000000000000000d) #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000003) (bvudiv x #x0000000000000004) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) x (bvudiv x #x0000000000000004)) (ite (= (bvsrem x #x000000000000000e) #x0000000000000000) (bvudiv x #x0000000000000004) (ite (= (bvand #x000000000000000e x) #x0000000000000000) #x0000000000000001 (ite (= (bvurem x #x0000000000000005) #x0000000000000003) (ite (= (bvor #x0000000000000006 x) x) #x0000000000000001 (ite (= (bvurem x #x0000000000000007) #x0000000000000002) #x0000000000000001 (bvudiv x #x0000000000000004))) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) #x0000000000000001 (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) #x0000000000000001 (bvudiv x #x0000000000000004))) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) #x0000000000000001 (bvudiv x #x0000000000000004))))))))))))
