...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvor #x0000000000000002 x) x) (bvudiv x #x0000000000000002) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001)) x) (ite (= (bvor #x0000000000000008 x) x) (bvor (bvlshr x #x0000000000000010) x) (ite (= (bvor #x0000000000000002 x) x) (bvudiv x #x0000000000000002) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001)))))
