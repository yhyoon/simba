...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (bvmul #x0000000000000003 x) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) #x0000000000000001 (ite (= (bvor #x0000000000000004 x) x) (bvmul #x0000000000000003 x) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvmul #x0000000000000003 x) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (bvmul #x0000000000000003 x) #x0000000000000001))))) (ite (= (bvor #x000000000000000a x) x) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvlshr x #x0000000000000005) (ite (= (bvashr x x) #x0000000000000000) (bvmul #x0000000000000003 x) (ite (= (bvsrem x #x000000000000000e) #x0000000000000000) (bvmul #x0000000000000003 x) (bvlshr x #x0000000000000005)))) (bvmul #x0000000000000003 x))) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvand #x000000000000000b x) #x0000000000000001) (bvlshr x #x0000000000000005) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvxor (bvlshr x #x0000000000000005) #x0000000000000001) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (bvxor (bvlshr x #x0000000000000005) #x0000000000000001) (ite (= (bvor #x000000000000000c x) x) (bvlshr x #x0000000000000005) (ite (= (bvurem x #x0000000000000006) #x0000000000000001) (bvxor (bvlshr x #x0000000000000005) #x0000000000000001) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvxor (bvlshr x #x0000000000000005) #x0000000000000001) (bvlshr x #x0000000000000005)) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvlshr x #x0000000000000005) (ite (= (bvor #x0000000000000009 x) x) (bvxor (bvlshr x #x0000000000000005) #x0000000000000001) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvlshr x #x0000000000000005) (bvxor (bvlshr x #x0000000000000005) #x0000000000000001)))))))))) #x0000000000000001)))
