...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) x (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) x (ite (= (bvurem x #x0000000000000006) #x0000000000000003) (bvnot x) (ite (= (bvand #x000000000000000f x) #x0000000000000003) x (ite (= (bvand #x0000000000000007 x) #x0000000000000003) (bvnot x) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvnot x) (ite (= (bvurem x #x000000000000000f) #x0000000000000001) (ite (= (bvsrem x #x0000000000000009) #x0000000000000001) (ite (= (bvor #x0000000000000002 x) x) x (bvnot x)) (bvnot x)) (ite (= (bvsrem x #x0000000000000008) #x0000000000000001) (ite (= (bvurem x #x0000000000000007) #x0000000000000003) x (bvnot x)) (ite (= (bvand #x000000000000000a x) #x0000000000000000) x (ite (= (bvurem x #x0000000000000006) #x0000000000000001) x (ite (= (bvand #x0000000000000009 x) #x0000000000000001) (bvnot x) (ite (= (bvsrem x #x0000000000000007) #x0000000000000001) (bvnot x) x)))))))))))) (ite (= (bvsrem x #x0000000000000007) #x0000000000000001) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) (bvnot x) (ite (= (bvurem x #x000000000000000b) #x0000000000000002) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x0000000000000009) #x0000000000000002) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000006) #x0000000000000002) (ite (= (bvand #x0000000000000003 x) #x0000000000000002) (ite (= (bvsrem x #x000000000000000a) #x0000000000000000) (bvnot x) (ite (= (bvurem x #x000000000000000d) #x0000000000000002) (bvnot x) (bvxor #x0000000000000001 x))) (bvnot x)) (ite (= (bvand #x000000000000000b x) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvnot x) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x0000000000000007) #x0000000000000002) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000005) #x0000000000000003) (ite (= (bvand #x000000000000000c x) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvashr x x) #x0000000000000000) (bvnot x) (bvxor #x0000000000000001 x))) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvxor #x0000000000000001 x) (bvnot x)))))))))))))))
