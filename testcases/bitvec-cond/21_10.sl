...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000006 x) x) (bvadd #x0000000000000002 x) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (bvmul #x0000000000000004 x) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvmul #x0000000000000004 x) (ite (= (bvand #x0000000000000008 x) #x0000000000000000) #x0000000000000002 (bvmul #x0000000000000004 x))))))
