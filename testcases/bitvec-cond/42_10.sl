...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x0000000000000003 x) x) (bvxor (bvadd x x) #x000000000000000e) (bvxor (bvadd x x) #x0000000000000006)) (bvlshr x #x0000000000000010)))
