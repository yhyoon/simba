...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000006 x) x) (bvnot (bvneg x)) (ite (= (bvor #x0000000000000002 x) x) (bvsub x (bvnot x)) (ite (= (bvor #x0000000000000008 x) x) (bvnot (bvneg x)) (bvsub x (bvnot x))))))
