...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x000000000000000d x) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (ite (= (bvand #x0000000000000005 x) #x0000000000000001) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (bvlshr x #x0000000000000010)) (bvor (bvudiv x #x0000000000000010) x)) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (ite (= (bvor #x0000000000000001 x) x) (bvlshr x #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)) (bvlshr x #x0000000000000010)) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (ite (= (bvashr x x) #x0000000000000000) (bvlshr x #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (ite (= (bvor #x0000000000000005 x) x) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvlshr x #x0000000000000010) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (bvlshr x #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)))) (ite (= (bvor #x000000000000000d x) x) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (ite (= (bvor #x0000000000000009 x) x) (bvlshr x #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)) (ite (= (bvand #x000000000000000e x) #x0000000000000000) (bvlshr x #x0000000000000010) (ite (= (bvand #x0000000000000003 x) #x0000000000000001) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvlshr x #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)) (bvlshr x #x0000000000000010)))) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (ite (= (bvor #x000000000000000c x) x) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvlshr x #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)) (ite (= (bvor #x0000000000000002 x) x) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (ite (= (bvor #x0000000000000004 x) x) (bvlshr x #x0000000000000010) (ite (= (bvashr x x) #x0000000000000000) (bvor (bvudiv x #x0000000000000010) x) (bvlshr x #x0000000000000010))) (bvor (bvudiv x #x0000000000000010) x))))))))))))))))))))
