...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvneg (bvnot x)) (ite (= (bvand #x000000000000000c x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvneg (bvnot x)) (bvudiv x #x0000000000000010)) (bvneg (bvnot x))) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvor #x000000000000000a x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvudiv x #x0000000000000010) (bvneg (bvnot x))) (bvudiv x #x0000000000000010)) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (bvneg (bvnot x)) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) (bvneg (bvnot x)) (ite (= (bvor #x0000000000000010 x) x) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (bvneg (bvnot x)) (ite (= (bvor #x000000000000000c x) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvudiv x #x0000000000000010) (bvneg (bvnot x))) (bvudiv x #x0000000000000010))))))))) (ite (= (bvor #x000000000000000e x) x) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvxor (bvudiv x #x0000000000000010) #x0000000000000003) x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvxor (bvudiv x #x0000000000000010) #x0000000000000001) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) x (ite (= (bvurem x #x0000000000000009) #x0000000000000001) x (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvxor (bvudiv x #x0000000000000010) #x0000000000000001) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvxor (bvudiv x #x0000000000000010) #x0000000000000001) x)))))) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) x (bvudiv x #x0000000000000010)) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) x (ite (= (bvurem x #x000000000000000c) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvxor (bvurem x #x000000000000000c) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvxor (bvurem x #x000000000000000c) x) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvxor (bvurem x #x000000000000000c) x) (bvudiv x #x0000000000000010)))) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x000000000000000e) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvor #x000000000000000c x) x) (bvudiv x #x0000000000000010) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) x (ite (= (bvurem x #x0000000000000005) #x0000000000000000) x (bvudiv x #x0000000000000010))) x) x)))))))))))
