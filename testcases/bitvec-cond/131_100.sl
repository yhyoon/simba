...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000003 x) #x0000000000000001) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005)) (bvlshr (bvnot x) #x0000000000000005)) (ite (= (bvor #x000000000000000d x) x) (ite (= (bvashr x x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005)) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvor #x0000000000000009 x) x) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005)) (bvxor #x0000000000000001 x)))))) (ite (= (bvand #x0000000000000005 x) #x0000000000000001) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvashr x x) #x0000000000000000) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvor #x0000000000000009 x) x) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvor #x0000000000000010 x) x) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005))) (bvlshr (bvnot x) #x0000000000000005)))) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (ite (= (bvsrem x #x000000000000000c) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005)) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvashr x x) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvand #x000000000000000c x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005))))) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x000000000000000a) #x0000000000000000) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvor #x0000000000000010 x) x) (bvxor #x0000000000000001 x) (ite (= (bvashr x x) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005))))) (ite (= (bvsrem x #x000000000000000c) #x0000000000000000) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvand #x0000000000000009 x) #x0000000000000001) (bvxor #x0000000000000001 x) (ite (= (bvor #x0000000000000010 x) x) (bvlshr (bvnot x) #x0000000000000005) (ite (= (bvor #x000000000000000e x) x) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005)) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x000000000000000b x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvlshr (bvnot x) #x0000000000000005)) (bvlshr (bvnot x) #x0000000000000005)))))))))))))))))
