...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x0000000000000005 x) x) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvor #x0000000000000010 x) x) #x0000000000000001 (bvudiv (bvlshr x #x0000000000000010) #x0000000000000010)) #x0000000000000001) (bvudiv (bvlshr x #x0000000000000010) #x0000000000000010)) (ite (= (bvor #x0000000000000002 x) x) #x0000000000000000 (ite (= (bvor #x0000000000000010 x) x) #x0000000000000000 (bvudiv (bvlshr x #x0000000000000010) #x0000000000000010)))))
