...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000004 x) x) (bvnot #x0000000000000001) (ite (= (bvor #x0000000000000001 x) x) #x0000000000000000 (bvudiv x #x0000000000000004))))
