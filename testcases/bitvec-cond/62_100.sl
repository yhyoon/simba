...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x000000000000000f x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvsub x (bvnot x)) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvsub x (bvnot x)) (bvnot (bvneg (bvudiv x #x0000000000000010))))) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvor #x0000000000000001 x) x) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)) (bvsub x (bvnot x))) (bvsub x (bvnot x))))) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (ite (= (bvor #x0000000000000002 x) x) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000005 x) #x0000000000000001) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)))) (ite (= (bvor #x000000000000000a x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvor #x0000000000000006 x) x) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)) (bvsub x (bvnot x))))) (ite (= (bvand #x0000000000000005 x) #x0000000000000001) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (ite (= (bvurem x #x000000000000000e) #x0000000000000000) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvurem x #x000000000000000e) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvor #x0000000000000001 x) x) (bvsub x (bvnot x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvudiv x #x0000000000000010) (ite (= (bvand #x000000000000000a x) #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)) (bvsub x (bvnot x))))) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (bvsub x (bvnot x)) (bvudiv x #x0000000000000010)))))))))))))))))
