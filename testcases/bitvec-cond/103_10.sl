...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvor #x0000000000000004 x) x) (bvor (bvlshr x #x0000000000000010) x) (bvudiv x #x0000000000000002)) (bvudiv x #x0000000000000002)) (ite (= (bvor #x0000000000000005 x) x) (ite (= (bvor #x0000000000000008 x) x) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001) x) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001))))
