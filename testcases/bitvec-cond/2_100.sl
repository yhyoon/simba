...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000002) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvurem x #x0000000000000006) #x0000000000000001) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvor #x000000000000000c x) x) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvor #x0000000000000008 x) x) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x000000000000000e) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x0000000000000006) #x0000000000000002) (ite (= (bvor #x0000000000000004 x) x) (bvudiv (bvnot x) #x0000000000000002) (bvnot (bvmul #x0000000000000008 x))) (bvnot (bvmul #x0000000000000008 x)))))))))) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000002) (ite (= (bvsrem x #x0000000000000005) #x0000000000000001) (bvudiv (bvnot x) #x0000000000000002) (bvnot (bvmul #x0000000000000008 x))) (bvudiv (bvnot x) #x0000000000000002))) (bvnot (bvmul #x0000000000000008 x)))) (bvnot (bvmul #x0000000000000008 x))))) (ite (= (bvurem x #x000000000000000a) #x0000000000000001) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvand #x000000000000000b x) #x0000000000000002) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x000000000000000b) #x0000000000000002) (bvudiv (bvnot x) #x0000000000000002) (bvnot (bvmul #x0000000000000008 x)))) (ite (= (bvurem x #x0000000000000007) #x0000000000000002) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x000000000000000f) #x0000000000000001) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x0000000000000009) #x0000000000000002) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvor #x0000000000000007 x) x) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvand #x000000000000000b x) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvsrem x #x0000000000000006) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvor #x0000000000000002 x) x) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x000000000000000b) #x0000000000000002) (bvudiv (bvnot x) #x0000000000000002) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (bvudiv (bvnot x) #x0000000000000002)) (bvnot (bvmul #x0000000000000008 x))))))))))))))))))))
