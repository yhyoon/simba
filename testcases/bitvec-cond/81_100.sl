...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) #x0000000000000001 (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) #x0000000000000000 (ite (= (bvsrem x #x0000000000000007) #x0000000000000001) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) (ite (= (bvand #x0000000000000009 x) #x0000000000000001) (bvlshr x #x0000000000000010) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvlshr x #x0000000000000010) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001))) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (ite (= (bvand #x0000000000000009 x) #x0000000000000001) (bvlshr x #x0000000000000010) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001)) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvlshr x #x0000000000000010) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001))) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001)))))) (ite (= (bvand #x0000000000000003 x) #x0000000000000002) #x0000000000000001 #x0000000000000000))))
