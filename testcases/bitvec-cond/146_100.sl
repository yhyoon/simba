...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000009 x) x) #x0000000000000001 (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) x (ite (= (bvsrem x #x0000000000000006) #x0000000000000000) (ite (= (bvand #x0000000000000003 x) #x0000000000000002) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) x (ite (= (bvor #x000000000000000c x) x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvsub x (bvnot x)) x) (bvsub x (bvnot x)))) (bvsub x (bvnot x))) (bvsub x (bvnot x))) (ite (= (bvor #x0000000000000001 x) x) x (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvurem x (bvnot x)) (ite (= (bvurem x #x000000000000000b) #x0000000000000002) (bvurem x (bvnot x)) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (bvurem x (bvnot x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) (bvurem x (bvnot x)) (ite (= (bvor #x000000000000000c x) x) (bvsub x (bvnot x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvsub x (bvnot x)) (bvurem x (bvnot x))))))))) (ite (= (bvurem x #x000000000000000c) #x0000000000000000) (bvurem x (bvnot x)) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000003 x) #x0000000000000002) (ite (= (bvurem x #x0000000000000009) #x0000000000000002) (bvsub x (bvnot x)) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) x (ite (= (bvurem x #x000000000000000d) #x0000000000000001) x (ite (= (bvor #x000000000000000c x) x) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) x (ite (= (bvor #x0000000000000010 x) x) x (bvurem x (bvnot x)))) (bvsub x (bvnot x))))))) x)))))))))
