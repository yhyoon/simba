...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvand #x000000000000000e x) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvand (bvadd x x) x) (bvxor #x0000000000000001 x)) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvxor #x0000000000000001 x) (bvand (bvadd x x) x))) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvand (bvadd x x) x)) (bvxor #x0000000000000001 x))))) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvand (bvadd x x) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvand (bvadd x x) x)) (bvxor #x0000000000000001 x)))))))) (ite (= (bvor #x0000000000000002 x) x) (bvneg (bvnot x)) (bvor #x0000000000000003 x))))
