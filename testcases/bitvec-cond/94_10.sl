...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000009 x) x) (bvnot #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvlshr x #x0000000000000010) (bvnot #x0000000000000001))))
