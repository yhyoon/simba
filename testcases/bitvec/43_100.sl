...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvand #x000000000000000c x) #x0000000000000000) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvsub x (bvnot x)) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (ite (= (bvurem x #x000000000000000c) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x0000000000000003 x) #x0000000000000002) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000002) (bvsub x (bvnot x)) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvsrem x #x0000000000000003) #x0000000000000001) (ite (= (bvurem x #x0000000000000007) #x0000000000000002) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (bvsub x (bvnot x))) (bvnot (bvadd (bvudiv x #x0000000000000010) x)))))) (bvnot (bvadd (bvudiv x #x0000000000000010) x)))))))))) (ite (= (bvor #x000000000000000e x) x) (bvsub x (bvnot x)) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (ite (= (bvand #x000000000000000a x) #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvnot (bvadd (bvudiv x #x0000000000000010) x)) (bvsub x (bvnot x))) (bvsub x (bvnot x)))))))))
