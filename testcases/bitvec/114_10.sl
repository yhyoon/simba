...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (bvadd (bvlshr x #x0000000000000005) x) (ite (= (bvor #x0000000000000010 x) x) (bvxor #x0000000000000001 x) x)))
