...
(synth-fun f ((x (BitVec 64)) (m (BitVec 64)) (k (BitVec 64))) (BitVec 64)
    ((Start (BitVec 64) ((bvand Start Start) (bvsub Start Start) (bvxor Start Start) (bvor Start Start) (bvand Start Start) (bvshl Start Start) (bvlshr Start Start) (bvashr Start Start) (bvnot Start) (bvneg Start) x m k))))
