...
(synth-fun f ((x (BitVec 64))) (BitVec 64)
    ((Start (BitVec 64) ((bvand Start Start) (bvxor Start Start) (bvor Start Start) (bvadd Start Start) (bvlshr Start Start) (bvneg Start) (bvudiv Start Start) x #x0000000000000002))))
